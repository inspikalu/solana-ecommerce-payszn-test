...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Track your crypto trades and investments.",
    price: "0.02999",
    image: "/placeholder.svg?height=400&width=400",
    details:
      "Keep track of your crypto trading journey with this beautifully designed journal. Includes sections for strategy planning and performance analysis.",
  },
  {
    id: "6",
    name: "Blockchain Conference Ticket",
    description: "Ticket to the annual blockchain conference.",
    price: "0.0349",
    image: "/placeholder.svg?height=400&width=400",
    details:
      "Join the biggest names in blockchain at this annual conference. Network with industry leaders and learn about the latest developments.",
  },
  {
    id: "7",
    name: "Crypto Mining Rig",
    description: "Complete setup for crypto mining.",
    price: "0.01299",
    image: "/placeholder.svg?height=400&width=400",
    details:
      "Start mining cryptocurrency with this complete mining rig. Optimized for performance and energy efficiency.",
  },
  {
    id: "8",
    name: "Blockchain Strategy Consultation",
    description: "One-hour consultation with a blockchain expert.",
    price: "0.0150",
    image: "/placeholder.svg?height=400&width=400",
    details:
